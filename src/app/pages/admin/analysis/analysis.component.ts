...
import { Customer } from './interfaces/analysis.model';
...
export class AnalysisComponent implements OnInit, AfterViewInit {
  ...
  createCustomer() {
    this.dialog.open(AnalysisCreateUpdateComponent).afterClosed().subscribe((customer: Customer) => {
      /**
  ...
  updateCustomer(customer: Customer) {
    this.dialog.open(AnalysisCreateUpdateComponent, {
      data: customer
