...
export class CommunicationComponent implements OnInit, AfterViewInit {
  ...
  columns: TableColumn<Communication>[] = [
    ...
    { label: 'Descargar', property: 'description', type: 'text', visible: true },
        ...
        console.log("Hola ", data.data)
          if(data.success){
            ...
            console.log(this.comunicationData)
              ...
              this.getData(this.Cartera).subscribe(datos => {
              ...
              this.data$.pipe(
                ...
                //console.log(datos)
                this.datos = datos;
                this.dataSource.data = datos; //this.CommunicationsList;
              });
