...
@UntilDestroy()
@Component({
  selector: 'vex-payment_promise-update',
  templateUrl: './payment_promise-update.component.html',
  styleUrls: ['./payment_promise-update.component.scss'],
  animations: [
    fadeInUp400ms,
    stagger40ms
  ],
})
export class PaymentPromiseUpdateComponent implements OnInit {
  ...
  constructor(@Inject(MAT_DIALOG_DATA) public defaults: any,
              private dialogRef: MatDialogRef<PaymentPromiseUpdateComponent>,
