...
export class SegmentationDeleteComponent implements OnInit {
  ...
  constructor(@Inject(MAT_DIALOG_DATA) public defaults: any,
              private dialogRef: MatDialogRef<SegmentationDeleteComponent>,
  ...
  deleteSegmentation() {
    //segmentation._id = this.defaults._id;
      this.deleteSegmentationA(this.defaults._id);
  }

  deleteSegmentationA(id) {
    this.Services.deleteSegmentation(id)
    .subscribe(
        data => {
          if(data.success){
