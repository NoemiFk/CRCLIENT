...
export class CustomerUpdateComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.form = this.fb.group({
      ...
      cfdiUse: [this.defaults.cfdiUse || ''],
      paymentForm:[this.defaults.paymentForm || '03'],
      ...
      email1: this.defaults.email1 || '',
      email2: this.defaults.email2 || ''
  ...
  updateCustomer() {
    ...
    let body= {
      ...
      "phone": customer.phone,
      "paymentForm":customer.paymentForm,
      "RFC": customer.RFC,
      "complete": true,
      "address": {
        "city": customer.city,
